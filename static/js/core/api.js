...
export const personnelAPI = {
  ...
  updateSalary: (id, data) =>
    api.put(`/personnel/salaries/${id}/`, data),

  markPaid: (id) =>
    api.post(`/personnel/salaries/${id}/mark_paid/`),

  getLeaves: (params) => api.get("/personnel/leaves/", { params }),
  createLeave: (data) => api.post("/personnel/leaves/", data),
  updateLeave: (id, data) =>
    api.put(`/personnel/leaves/${id}/`, data),

  approveLeave: (id) =>
    api.post(`/personnel/leaves/${id}/approve/`),

  rejectLeave: (id, notes) =>
    api.post(`/personnel/leaves/${id}/reject/`, { notes }),
};
